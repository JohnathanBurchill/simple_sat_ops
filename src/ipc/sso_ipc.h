/*
    ...
    Simple Satellite Operations  src/ipc/sso_ipc.h
...
typedef struct {
    ...
    int has_state;
    char satellite[64];
    // Provenance of this STATE: "tle-only" when generated by a
    // --viewer-stream relay propagating the TLE itself (no operator),
    // "operator" when it came from / was relayed from a live operator.
