...
// ring are fields on state_t. The modal itself lives in ui/tx_compose;
// it is ticked alongside the main loop (non-blocking) so tracking +
// rotator + IPC fanout keep flowing during composition.
